...
function init_gear_sets()
	...
	sets.defense.PDT = {
		...
		legs="Arke Cosciales",feet="Sulevia's Leggings +2"}
	...
	sets.engaged = {ammo="Ginsen",
		...
		back="Cichol's Mantle",waist="Ioskeha Belt",legs="Argosy Breeches +1",feet="Argosy Sollerets +1"}
	...
	sets.engaged.Acc = set_combine(sets.engaged, {
		...
		body="Valorous Mail",ring1="Cacoethic Ring +1",
		waist="Olseni Belt"})
