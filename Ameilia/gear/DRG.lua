...
function init_gear_sets()
	...
	sets.engaged = {ammo="Ginsen",
		...
		body="Dagon Breastplate",hands="Sulevia's Gauntlets +2",ring1="Flamma Ring",ring2="Petrov Ring",
	...
	sets.engaged.Acc = set_combine(sets.engaged, {
		...
		body="Dagon Breastplate",hands="Vishap FInger Gauntlets +3",ring1="Cacoethic Ring +1",ring2="Patricius Ring",
	...
	sets.HB.Pre = {head="Drn. Armet +1",neck="Lavalier +1",ear1="Bloodgem Earring",ear2="Etiolation Earring",
		...
		back="Moonbeam Cape",waist="Glassblower's Belt",legs="Arke Cosciales",feet="Sulevia's Leggings +2"}
	sets.HB.Mid = {
		...
		back="Brigantia's Mantle",waist="Glassblower's Belt",legs="Vishap Brais +3",feet="Pteroslaver Greaves +1"}
	...
	sets.precast.WS = {ammo="Knobkierrie",
		...
		body="Dagon Breastplate",hands="Sulevia's Gauntlets +2",ring1="Shukuyu Ring",ring2="Ifrit Ring +1",
		back="Brigantia's Mantle",waist="Fotia Belt",legs="Valorous Hose",feet="Sulevia's Leggings +2"}
	sets.precast.WS.Acc = set_combine(sets.precast.WS, {
		ear1="Telos Earring",ear2="Dignitary's Earring",
		body="Dagon Breastplate",hands="Vishap Finger Gauntlets +3",ring1="Flamma's Ring",ring2="Cacoethic Ring +1",
	...
	sets.precast.WS['Geirskogul'] = set_combine(sets.precast.WS, {
		ring2="Ramuh Ring +1"})
	sets.precast.WS['Camlann\'s Torment'] = set_combine(sets.precast.WS, {head=gear.wsdmg.head})
	...
	sets.idle = set_combine(sets.engaged, {
		...
		back="Moonbeam Cape",legs="Carmine Cuisses +1"})
	...
	sets.defense.PDT = {ammo="Staunch Tathlum",
		...
		back="Moonbeam Cape",waist="Flume Belt",legs="Arke Cosciales",feet="Sulevia's Leggings +2"}
