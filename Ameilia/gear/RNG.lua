...
function init_gear_sets()
	...
	sets.midcast.RA = {
		head="Arcadian Beret +3",neck="Scout's Gorget +2",ear1="Telos earring",ear2="Crepuscular Earring",
	...
	sets.midcast.RA.Acc = set_combine(sets.midcast.RA,
		{neck="Null Loop",ear1="Telos Earring",back="Null Shawl"})
	...
	sets.buff['Double Shot'] = {head="Oshosi Mask +1",body="Arcadian Jerkin +3",legs="Oshosi Trousers +1",feet="Oshosi Leggings +1"}
end