...
function init_gear_sets()
	...
	sets.engaged = {
		head="Adhemar Bonnet +1",neck="Null Loop",ear1="Mache Earring",ear2="Cessance Earring",
		body="Adhemar Jacket +1",hands=gear.melee.hands,ring1="Cacoethic Ring +1",ring2="Cacoethic Ring",
		back="Null Shawl",waist="Null Belt",legs=gear.melee.legs,feet=gear.melee.feet}
    ...
    sets.precast.WS = {ammo=gear.WSbullet,
		...
		body="Laksamana's Frac +3",hands="Nyame Gauntlets",ring1="Garuda Ring",ring2="Garuda Ring",
		back=gear.rng.back,waist="Fotia Belt",legs="Nyame Flanchard",feet="Nyame Sollerets" }

	sets.meleeWS = set_combine(sets.precast.WS, {
		neck="Fotia Gorget",waist="Fotia Belt",ring1="Cornelia's Ring",ring2="Karieyh Ring"
	})	
	...
	sets.precast.WS['Savage Blade'] = set_combine(sets.meleeWS, {neck="Republican Platinum Medal",waist="Cornelia's Belt"})
    ...
    sets.precast.WS['Wildfire'] = {ammo=gear.MAbullet,
        ...
        body="Laksamana's Frac +3",hands="Nyame Gauntlets",ring1="Cornelia's Ring",ring2="Dingir Ring",
        back=gear.rng.back,waist="Sveltesse Gouriz +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
    ...
    sets.precast.CorsairShot['Light Shot'] = set_combine(sets.precast.CorsairShot, {
		head="Mummu Bonnet +2",ear1="Gwati Earring",ear2="Dignitary's Earring",
